...
const ArraySearchCharacter: FC = () => {
    ...
    return <div className='grid tablet:grid-cols-1 laptop:grid-cols-2 desktop:grid-cols-3 gap-1'>
        {
            infoList.map((data) => <div key={data.name} className='flex p-2 flex-row items-center gap-2 shadow-lg shadow-stone-500 rounded-lg bg-stone-100 dark:bg-slate-800 dark:text-white'>
